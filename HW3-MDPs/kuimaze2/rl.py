...
class RLProblem:
    ...
    def __init__(self, mdp: MDP):
        self.mdp = mdp
        self.current_state = next(iter(mdp._goals))
    ...
    def reset(self, /, state: Optional[State] = None, random_start: bool = False):
        ...
        if state:
            ...
            self.current_state = self.mdp._map.start
    ...
    def step(self, action: Action):
        ...
        self.current_state = self.mdp._get_transition_result(self.current_state, action)
