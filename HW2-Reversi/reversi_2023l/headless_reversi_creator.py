...
class HeadlessReversiCreator(object):
    ...
    def __init__(self, player1, player1_color, player2, player2_color, board_size=8):
        ...
        :param board_size: Board will have size [boardSize x boardSize]
        """
    ...
    def play_game(self):
        ...
        while self.board.can_play(self.current_player_color):
            ...
            if move is None:
                print('Player %d reurns None instead of a valid move. Move takes %.3f ms.' % (self.current_player_color, moveTime))
