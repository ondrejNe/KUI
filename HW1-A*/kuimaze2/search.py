...
class SearchProblem:
    ...
    def __init__(self,
                 map: Map,
                 costs: Optional[StateRoleCosts] = None,
                 graphics: bool = False):
        """
        ...
        self._view: SearchView = NullSearchView(self) if not graphics else TkSearchView(self)
    ...
    def get_transition_result(self, state: State, action: Action) -> tuple[State, float]:
        ...
        return (successor, self._costs[self.map[state].role])
    ...
    def render(self, *args, **kwargs):
        ...
        Arguments (all optional):
            ...
            colors: dict[State, float] = {},
                ...
                Other state are visited once they appear as a result of `get_transition_result(...)`.
